  ...
  return (
    <>
      <div className="flex flex-col-reverse sm:flex-row">
        ...
        <div className="sm:w-1/2 flex p-3 text-left flex-col justify-center pb-8 sm:p-8 md:w-4/5 sm:text-center sm:mx-auto">
          <div className="right_in ">
            <h1
              className="text-[#eff0f5] p-1 text-2xl sm:text-4xl md:text-5xl drop-shadow-[0_2px_2px_#cc00ff] font-[300]"
            ...
            <div className="flex flex-col text-left space-y-3 justify-center p-2 sm:p-8 sm:w-4/5 sm:text-center sm:mx-auto">
              <div className="text-[#9ba0b8] text-base space-y-3 sm:p-8 md:p-10  md:text-xl">
                <p>
      ...
      <div className="flex flex-col sm:flex-row justify-center py-10 px-6 sm:px-12 sm:py-12 gap-y-3 ">
        <div className="flex flex-col-1 gap-y-5 sm:w-[50%] text-left">
          <div className="right_in ">
            <h1
              className="text-[#eff0f5] text-2xl  sm:text-4xl md:text-5xl drop-shadow-[0_2px_2px_#cc00ff] font-light"
              data-text="The Rise of Legends"
            >
              How to Mint
            </h1>
            ...
            <div className="text-[#9ba0b8] text-base sm:p-10 md:text-xl space-y-4">
              <p>
            ...
            {/* // MINT SECTION */}
        <div className="flex flex-col-1 gap-y-5 sm:w-[50%] ">
          <div className="grid grid-cols sm:grid-cols-2 md:gap-12 sm:gap-6">
            <MintCard num={`${0}${1}`} text={"CONNECT YOUR WALLET"} />
            ...
            {isVideoPlaying ? (
              <div className="video-container">
                ...
                <button
                  ...
                  className="absolute bottom-2 right-2 px-4 py-2 bg-red-600 text-white rounded"
                >
                  X
                </button>
              </div>
              ...
              <div className="awt-tv relative col-span-2">
                <div className="explore-area">
                  ...
                  />
                  <div
                    className="explore-btn absolute inset-0 flex justify-center items-center"
                    id="button1"
                  >
                    <span
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M22.3958 0C10.027 0 0 10.027 0 22.3958C0 34.7647 10.027 44.7917 22.3958 44.7917C34.7647 44.7917 44.7917 34.7647 44.7917 22.3958C44.7917 10.027 34.7647 0 22.3958 0ZM3.125 22.3958C3.125 11.7528 11.7528 3.125 22.3958 3.125C33.0388 3.125 41.6667 11.7528 41.6667 22.3958C41.6667 33.0388 33.0388 41.6667 22.3958 41.6667C11.7528 41.6667 3.125 33.0388 3.125 22.3958Z"
                          fill="white"
                        />
                        <path
                          d="M27.607 21.5013L19.1325 17.2641C18.3346 16.8651 17.3958 17.4453 17.3958 18.3374V26.4541C17.3958 27.3462 18.3346 27.9264 19.1325 27.5274L27.607 23.2902C28.344 22.9217 28.344 21.8698 27.607 21.5013Z"
                          fill="white"
                          stroke="white"
                          strokeWidth={2}
                          strokeLinecap="round"

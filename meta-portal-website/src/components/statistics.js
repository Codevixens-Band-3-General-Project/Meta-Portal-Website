function Statistics(props) {
  return (
    <div className="card flex flex-col sm:flex-row justify-around p-3 sm:py-12 border-t border-b border-[#ffffff21] bg-[#00000026]">
      ...
      <div className="card flex flex-col py-7 gap-2  ">
        <h1 className="text-4xl font-bold text-[#17091d] text-center stats">
          3.9K+
        </h1>
